                    ...
                    <div className="row">
                        <div className="col-3">
                            <div className="position-relative">
                                <img className="img-fluid" src="assets/img/avatar.png" alt="Profile Avatar" />
                                <div 
                        ...
                        <div className="col-9">
                            <h6 className="p-2" style={{ backgroundColor: '#666666', width: '90%' }}>Strive Student</h6>
                            ...
                            <button className="buttonProfile mb-2 px-2 py-1">All maturity ratings</button>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                />
                                <label htmlFor="autoplayEpisodes" className="mb-0 ms-1">Autoplay next episode in a series on all devices.</label>
                            </div>
                            <div className="mt-1 d-flex align-items-center">
                                ...
                                />
                                <label htmlFor="autoplayPreviews" className="mb-0 ms-1">Autoplay previews while browsing on all devices.</label>
                            </div>
                        </div>
                        <hr className="my-4" />
                        <div className="p-0 d-flex">
                            ...
                            <button className="deleteButtonGray ms-2">Delete Profile</button>
                        </div>
                    </div>
                </div>
            </main>
